...
// This is the "TypeScript" part - we define what data the Boss needs
interface BossProps {
  hp: number;
  maxHp: number;
}

export default function Boss({ hp, maxHp }: BossProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full">
      ...
      {/* HEALTH BAR */}
      <div className="w-96 h-8 bg-gray-800 rounded-full mt-8 border-2 border-gray-700 overflow-hidden relative">
        <motion.div
